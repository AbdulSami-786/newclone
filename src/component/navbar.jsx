    ...
    <div className="fixed top-0 left-0 right-0 bg-white z-10 shadow-md">
        ...
        <div className="flex-none lg:hidden">
          <div className="dropdown dropdown-end">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
              ...
              <li><Link to="/login"className="inline-block text-black font-semibold mr-2 py-2 px-6 rounded-lg transition-all duration-300 ease-in-outhover:bg-gradient-to-r hover:from-pink-500 hover:to-purple-600 hover:scale-105 hover:shadow-lg hover:text-yellow-100">SIGN UP</Link></li>
              <li><Link to="/cart"className="relative inline-flex items-center gap-2 bg-gradient-to-r from-orange-400 to-orange-600 
               text-white font-semibold py-2 px-5 rounded-full shadow-md 
               transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg">🛒 Cart<span className="absolute -top-2 -right-3 bg-white text-orange-600 font-bold text-xs 
                     w-6 h-6 flex items-center justify-center rounded-full shadow"> {cartItems.length} </span></Link></li>
            </ul>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between px-4 py-3 bg-gray-100 gap-3">
        ...
        <div className="flex items-center gap-4">
          <Link to="/signup">
            <span className="font-medium cursor-pointer underline decoration-solid  hover:no-underline">Login</span>
          </Link>
